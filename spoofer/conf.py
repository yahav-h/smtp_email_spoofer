...
required.add_argument('--cc', dest='cc', required=False, type=int, nargs='+', help='Split multiple recipients to CC')
...
# Mass Send
required.add_argument('--mass-send', dest='mass_send', required=False, type=int, help='number of mass send')